			...
			<tr class='table-striped'>
				...
				<td>
					...
					<a class='glyphicon glyphicon-search' 
						data-toggle="modal" 
						data-target="#inclusionModal" 
						href='?module=Programmes&action=detail&id=<?php echo $_smarty_tpl->tpl_vars['donnees']->value['id'];?>
...
&displayModuleInDialog=1'>
					...
					<a class='glyphicon glyphicon-pencil' 
						data-toggle="modal" 
						data-target="#inclusionModal"
						href='?module=Programmes&action=modifier&id=<?php echo $_smarty_tpl->tpl_vars['donnees']->value['id'];?>
&ref=<?php echo $_smarty_tpl->tpl_vars['donnees']->value['Nom_Programme'];?>
&displayModuleInDialog=1'>
					</a>
...
'></a>
					...
					<!--avis-->
					<a class='glyphicon glyphicon-heart-empty' title='<?php echo $_smarty_tpl->tpl_vars['donnees']->value['Nom_Porgramme'];?>
' 
						href='?module=afficheavis&action=afficher&id=<?php echo $_smarty_tpl->tpl_vars['donnees']->value['id'];?>
&ref=<?php echo $_smarty_tpl->tpl_vars['donnees']->value['Nom_Programme'];?>
'></a>
				</td>
			</tr>
